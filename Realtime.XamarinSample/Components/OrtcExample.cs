...
namespace Realtime.XamarinSample
{
	public class OrtcExample : INotifyPropertyChanged
	{
		...
		public void DoConnectDisconnect(object sender, EventArgs e) {
		...
		public void DoConnect(object sender, EventArgs e) {
			ortcClient.ConnectionMetadata = ConnectionMetadata;
			if (IsCluster)
				ortcClient.ClusterUrl = Url;
			else
		...
		public void DoDisconnect(object sender, EventArgs e) {
			ortcClient.Disconnect();
			WriteLog("Disconnecting...");
		}

		public void DoSendMessage(object sender, EventArgs e) {
			ortcClient.Send(Channel, Message);
		}

		public void DoSubscribe(object sender, EventArgs e) {
		...
		public void DoUnsubscribe(object sender, EventArgs e) {
			ortcClient.Unsubscribe(Channel);
		}

		public void DoClearLog(object sender, EventArgs e) {
			Log = "";
			//NotifyPropertyChanged("Log");
		}

		public void DoGetPresence(object sender, EventArgs e) {
		...
		public void DoEnablePresence(object sender, EventArgs e) {
		...
		public void DoDisablePresence(object sender, EventArgs e) {
		...
		public void DoSaveAuthentication(object sender, EventArgs e) {
